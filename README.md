...
点此[here](https://docs.spring.io/spring-boot/docs/current/reference/html/boot-features-caching.html#boot-features-caching-provider-none)查看更多。

**警告**：如果您使用第二级 hibernate 缓存并禁用 spring 缓存，则也必须禁用第二级 hibernate 缓存，因为它们正在使用
相同的 CacheManager。
