...
import com.zbdigit.myapp.domain.UploadImage;
import com.zbdigit.myapp.oss.OssTemplate;
import com.zbdigit.myapp.oss.model.BladeFile;
import com.zbdigit.myapp.repository.UploadImageRepository;
...
import com.zbdigit.myapp.service.mapper.UploadImageMapper;
...
public class UploadImageService {
    ...
    private final List<String> relationCacheNames = Arrays.asList(com.zbdigit.myapp.domain.User.class.getName() + ".uploadImage");
